...
var headLabel1 = Ti.UI.createLabel({
	...
	color:'#8a1504',
	font:{fontFamily:'papyrus', fontSize:'25sp',}
...
var textLabel4 = Ti.UI.createLabel({
	...
	left:'30dp',
	right:'30dp',
	text:'När du doftat klart är det äntligen dags att smaka på dessa ljuvliga bubblor. Här avgör man om doften stämmer med smaken. Ta en stor klunk och gurgla runt i gommen ordentligt. Använd även här sinnen och minnen för att avgöra smaken eller bouqueten som man så fint kallar det på vinspråk.\n\nBeskriv hur bubblorna känns i munnen. Beroende på hur det mousserande vinet är framställt får bubblorna olika karaktär. Läs mer om det under rubriken "utseende". Är bubblorna många, mindre och intensiva eller större, färre och mindre hållbara.\n\nBedöm sötman i vinet. Allt från 1 (helt torr) till 12 (mycket söt) förekommer. Mousserande viner räknas som halvtorra om de hamnar mellan 5-8.\n\nDet är först nu man kan avgöra om vinet är "balanserat", dvs om utseende, doft och smak stämmer överens med varandra. Jämför era anteckningar från de olika sinnena. Fanns doften av citrus även i smaken?\n\nProva sedan vinerna tillsammans med de "smakprover" ni har. Det är intressant hur vinet kan ändra karaktär beroende av vilka smaker det kombineras med. Observera t ex att "hettan" i kryddstarka saker blir mindre tillsammans med ett sötare vin.',
	font:{fontFamily:'arial', fontSize:'14sp'},
	html:true,
